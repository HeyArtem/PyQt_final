...
class CustomLabel(QLabel):
    def __init__(self, parent=None):
        ...
        self.rectangle = None
        self.page = None
        # для нескольких на одной странице
        self.to_page_rectangles = []
    ...
    def mouseReleaseEvent(self, event):
        ...
        if self.rectangle:
            # для нескольких на одной странице
            self.to_page_rectangles.append(self.rectangle)
            self.data_rectangles.setdefault(self.page, []).append(self.rectangle)
    ...
    def paintEvent(self, event):
        ...
        painter.setPen(pen)
        # для нескольких на одной странице
        for rect in self.to_page_rectangles:
        ...
        # если был создан прямоугольник на текущей странице до этого
            ...
            for rect in self.data_rectangles[self.page]:
                painter.drawRect(rect)
...
class PDFReader(QMainWindow):
    def __init__(self):
        ...
        # добавление виджетов на вертикальный слой Выравнивание
